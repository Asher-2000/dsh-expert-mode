...
| 专家 Expert | 委派工具 Tool | 擅长领域 |
|------------|---------------|---------|
| 数据分析师 Data Analyst | `expert_data_analyst` | 数据处理、统计、可视化 |
| 文案撰写 Copywriter | `expert_copywriter` | 营销文案、内容创作 |
| 合同/法务审查 Legal Review | `expert_legal_review` | 合同条款、法律风险 |
| 产品经理 Product Manager | `expert_product_manager` | 需求分析、产品规划 |
| 前端开发 Frontend Dev | `expert_frontend_dev` | Web 前端实现 |
| UI/UX 设计 UI/UX Design | `expert_uiux_design` | 界面设计、交互 |
| 架构师 Architect | `expert_architect` | 系统设计、技术选型 |
| 全社交平台运营 Social Media Ops | `expert_social_media` | 多平台内容分发 |
| 增长黑客 Growth Hacker | `expert_growth` | 增长策略、转化优化 |
| 金融/量化 Quant Finance | `expert_quant_finance` | 量化模型、金融分析 |
| 财务 Finance | `expert_finance` | 财务分析、报表 |
